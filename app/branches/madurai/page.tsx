...
export default function BranchMadurai() {
  const facilities = [
  ...
  return (
    <div>
      <PageBanner
        title="Madurai Branch"
        subtitle="Experience authentic Ayurvedic care in the heart of Madurai"
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center mb-20">
            ...
            >
              <div className="inline-block px-4 py-2 bg-[#FFF8E7] border border-[#D4AF37] rounded-full mb-4">
                <span className="text-[#2D5016] font-semibold">Madurai Branch</span>
              </div>

              <h2 className="text-4xl font-bold text-[#2D5016] mb-6">
                Your Wellness Destination in Madurai
              </h2>

              <p className="text-lg text-gray-600 mb-6 leading-relaxed">
                Our Madurai branch is strategically located in the heart of the city, providing
              ...
              <div className="space-y-4 mb-8">
                <div className="flex items-start gap-3 p-4 bg-[#FFF8E7] rounded-xl">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">No 6, Veeru Towers, Jawaharlal Nehru Salai, Hindustan Teleprinters Staff Quarters, SIDCO Industrial Estate, Ekkatuthangal, Madurai, Tamil Nadu 600032</p>
                  </div>
                </div>
